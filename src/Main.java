...
public class Main {
    ...
    private final static String ERROR_EMPTY_COLLECTION = "ПОМИЛКА! Ви не додали жодного співробітника до відомості! " +
            "\nОберіть опцію 1 або опцію 7, щоб ввести дані про співробітників";
    public static void main(String[] args) throws IOException, NoSuchElementException {
        ...
        while (option != 8) {
            ...
            System.out.println("""
                     ...
                     2 - Видалити дані
                     3 - Оновити дані
                     4 - Надрукувати таблицю з даними
                     5 - Використати певні запити
                     6 - Зберегти дані до файлу
                     7 - Імпортувати дані із файлу
                     8 - Завершити роботу програми\
                    """);
            System.out.println("\nОберіть опцію головного меню:");
            try {
                option  = scanner.nextInt();
                switch (option) {
                    case 1 -> {
                        System.out.print("\nВведіть кількість співробітників: ");
                        ...
                        for (int i = 0; i < countRequest; i++) {
                            ...
                            System.out.print("Введіть заробітню плату за годину: ");
                            int hourlyWage = scanner.nextInt();
                            System.out.print("Введіть кількість годин роботи за місяць: ");
                            int numberHoursWorked = scanner.nextInt();
                            scanner.nextLine();
                            Employee employee = new Employee(surname, position, numberHoursWorked, hourlyWage);
                            sheet.addEmployee(employee);
                        }
                        System.out.println("\nДані про співробітників успішно додано!");
                    }
                    case 2 -> {
                    ...
                    case 3 -> {
                        ...
                        sheet.updateEmployee(surnameNumber - 1, columnNumber);
                    }
                    case 4 -> {
                        if (sheet.getEmployeeList().isEmpty()) {
                            System.out.println(ERROR_EMPTY_COLLECTION);
