...
public class EmployeeList {
    ...
    public void deleteEmployee(int n) {
        if (n >= 0 && n < employeeList.size()) {
            System.out.println("Видалення даних про співробітника з прізвищем: "
                    + employeeList.get(n).getSurname());
    ...
    public void updateEmployee(int surnameNum, int columnNum) {
    ...
    public static void printTable(Stream<Employee> employeeStream) {
